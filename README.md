# TrackShowerGNN
GNN classification of track/shower clusters for DUNE LArTPC detectors, created as part of REU project for Aaron Meade, @ University of Kansas, Summer 2026 w/ Dr. Maria Brigida Brunetti
...
* **optimal_model.pt**: Saved weights for the optimal model. File can be replaced to load in new weights, as long as hyperparamters in the model architecture are set to match the model which generated the pt file.
